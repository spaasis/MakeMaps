...
export class OnScreenLegend extends React.Component<{ state: AppState }, {}>{
    createLegend(layer: Layer, showLayerName: boolean, showSeparator: boolean) {
        ...
        if (!isHeat && (sym.symbolType === SymbolTypes.Simple || sym.symbolType === SymbolTypes.Chart) && (sym.sizeXVar || sym.sizeYVar)) {
    ...
    render() {
        ...
        return (
            <div className={'legend' + classExtension} //animate with menu open/close
                ...
                {legend.meta ?
                    <div style={{ clear: 'both', padding: 10 }} dangerouslySetInnerHTML={{ __html: legend.meta }} /> : null}
            </div >
